...
void run_tests(object me) {
    ...
    write_file("/data/yaml/routes/settlements/route_test_era_restriction.yaml", test_route_yaml, 1);
    route_d->rehash();
    ...
    // ── 4. 還原與清理 ──────────────────────────────────────────
    rm("/data/yaml/routes/settlements/route_test_era_restriction.yaml");
    route_d->rehash();
