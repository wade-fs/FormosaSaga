...
### 🗺️ P10 — 府城、新港與嘉義市地理板塊大深化 (地理擴展規劃)
為了更豐富民雄以外的聚落地圖深度、自訂任務線，我們已將深化的佈局與任務設計整理至專屬計畫書：
> 詳見 [Geographical_Expansion_Plan.md](file:///home/wade/src/github/FormosaSaga/docs/Geographical_Expansion_Plan.md)
- [ ] **P10.1 — 嘉義市地標擴充（東市場、藍田書院、製材所）**
- [ ] **P10.2 — 新港鄉地標擴充（奉天宮、笨港第一庄、古渡口）**
- [ ] **P10.3 — 台南府城地標擴充（天后宮、熱蘭遮城內城、五條港）**
- [ ] **P10.4 — 鹿港九曲巷與防衛迷宮探索玩法實作**
- [ ] **P10.5 — 自訂任務線實作（笨港開圳、鄭成功大員登陸明鄭信件翻譯）**
- [x] **P9.2 — 鹿港工藝聚落與職涯深化**
